export const Logo = () => {
  return (
    <svg
      className="illustration styles_illustrationTablet__1DWOa w-4/5 m-auto "
  ...
  return (
    <div className="relative bg-gray-50">
      ...
      <main className="lg:relative">
        <div className="mx-auto w-full max-w-7xl pt-16 pb-20 text-center lg:py-48 lg:text-left">
          <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              <span className="block text-blue-600 xl:inline">Ücretsiz </span>
              <span className="block xl:inline">
                Online Öğrenme Platformu
              </span>{" "}
            </h1>
            <p className="mx-auto mt-3 max-w-md text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
              Türkçe yazılım eğitimi veren en eksiksiz adrese hoş geldiniz!
              Türkiyenin teknoloji konusunda gelişmesine hep beraber tanık
              olalım.
            </p>
        ...
        <div className="relative h-64 w-full sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:h-full lg:w-1/2 flex">
          <Logo />
        </div>
      </main>
    </div>
